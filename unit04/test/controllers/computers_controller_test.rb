...
class ComputersControllerTest < ActionController::TestCase
  ...
  test "should create computer" do
    assert_difference('Computer.count') do
      post :create, computer: { brand: @computer.brand, price: @computer.price, screen_size: @computer.screen_size }
    end
  ...
  test "should update computer" do
    patch :update, id: @computer, computer: { brand: @computer.brand, price: @computer.price, screen_size: @computer.screen_size }
    assert_redirected_to computer_path(assigns(:computer))
  end
